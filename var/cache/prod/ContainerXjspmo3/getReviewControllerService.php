...
// Returns the public 'WCS\CoavBundle\Controller\ReviewController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/WCS/CoavBundle/Controller/ReviewController.php';

return $this->services['WCS\CoavBundle\Controller\ReviewController'] = new \WCS\CoavBundle\Controller\ReviewController();
