...
class Reservation extends \WCS\CoavBundle\Entity\Reservation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WCS\\CoavBundle\\Entity\\Reservation' . "\0" . 'id', '' . "\0" . 'WCS\\CoavBundle\\Entity\\Reservation' . "\0" . 'nbReservedSeats', '' . "\0" . 'WCS\\CoavBundle\\Entity\\Reservation' . "\0" . 'publicationDate', '' . "\0" . 'WCS\\CoavBundle\\Entity\\Reservation' . "\0" . 'passengers', '' . "\0" . 'WCS\\CoavBundle\\Entity\\Reservation' . "\0" . 'flight', '' . "\0" . 'WCS\\CoavBundle\\Entity\\Reservation' . "\0" . 'wasDone'];
        }
