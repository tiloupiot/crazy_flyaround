...
}, 'WCS\\CoavBundle\\Form\\FlightType' => function () {
    return ${($_ = isset($this->services['WCS\CoavBundle\Form\FlightType']) ? $this->services['WCS\CoavBundle\Form\FlightType'] : $this->services['WCS\CoavBundle\Form\FlightType'] = new \WCS\CoavBundle\Form\FlightType()) && false ?: '_'};
}, 'WCS\\CoavBundle\\Form\\PlaneModelType' => function () {
    return ${($_ = isset($this->services['WCS\CoavBundle\Form\PlaneModelType']) ? $this->services['WCS\CoavBundle\Form\PlaneModelType'] : $this->services['WCS\CoavBundle\Form\PlaneModelType'] = new \WCS\CoavBundle\Form\PlaneModelType()) && false ?: '_'};
}, 'WCS\\CoavBundle\\Form\\ReservationType' => function () {
    return ${($_ = isset($this->services['WCS\CoavBundle\Form\ReservationType']) ? $this->services['WCS\CoavBundle\Form\ReservationType'] : $this->services['WCS\CoavBundle\Form\ReservationType'] = new \WCS\CoavBundle\Form\ReservationType()) && false ?: '_'};
}, 'WCS\\CoavBundle\\Form\\ReviewType' => function () {
    return ${($_ = isset($this->services['WCS\CoavBundle\Form\ReviewType']) ? $this->services['WCS\CoavBundle\Form\ReviewType'] : $this->services['WCS\CoavBundle\Form\ReviewType'] = new \WCS\CoavBundle\Form\ReviewType()) && false ?: '_'};
